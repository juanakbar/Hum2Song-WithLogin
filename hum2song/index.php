...
?>
                        ...
                        <div class="bottom">
                            <center>
                                <div class="bottomSection">
                                    <div class="theme" id="theme_0"></div>
                                    <div class="theme" id="theme_1"></div>
                                    <div class="theme" id="theme_2"></div>
                                    <div class="theme" id="theme_3"></div>
                                    <div class="theme" id="theme_4"></div>
                                    <div class="theme" id="theme_5"></div>
                                </div>
                                <div class="bottomSection">
    ...
    http://www.carlostoxtli.com -->
        ...
        <noscript>
            <div class="statcounter"><a title="web statistics" href="http://statcounter.com/" target="_blank"><img class="statcounter" src="//c.statcounter.com/11706293/0/d809fc4a/1/" alt="web
    statistics"></a></div>
        </noscript>
